...
function ContactUs() {
  return (
    <div className='flex flex-col py-8 space-y-6 bg-primary-600 p-8 border-4 rounded-tl-3xl rounded-br-3xl w-3/3 h-[600px]'>
        <div className='flex h-[500px] '>
            <div className='px-16 py-16 space-y-2 w-[50%]'>
                <p className='text-primary-300 font-semibold text-[20px]'>CONTACT US</p>
                <h1 className='text-white font-semibold text-[48px]'>You Deserve the best!</h1>
                ...
                <div className='flex gap-x-6'>
                    ...
                    <div>
                        ...
                        <p className='text-white font-semibold text-2xl'>nishanleather@gmail.com</p>
                    </div>
                </div>
                <div className='flex gap-x-6'>
                    <div class='bg-primary-700 w-14 h-14 rounded-lg flex justify-center items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-white font-semibold text-2xl'>0912932797  -  0903632274</p>
                    </div>
                </div>
            ...
            <div className='relative py-8 rounded-tl-3xl rounded-br-3xl w-[50%] h-full '>
